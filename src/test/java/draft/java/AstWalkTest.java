...
public class AstWalkTest extends TestCase {
    ...
    public void testWalkParents() {
        ...
        W.parents(_m, n -> parentNodes.add( _java.of( n ) ));
    ...
    public void testWalkAnno(){
        ...
        W.in(W.POST_ORDER, ast, Ast.STRING_LITERAL_EXPR, n-> true, n-> l.add(n));
    ...
    public void testWalkPreorderOrPostOrder(){
        ...
        W.preOrder(ast, Ast.INT_LITERAL_EXPR, n->true, n-> i.add(n.asInt()));
        ...
        W.postOrder(ast, Ast.INT_LITERAL_EXPR, n->true, n-> i.add(n.asInt()));
        assertEquals(i.size(), 3);
        assertEquals( (Integer)100, i.get(0) );
        assertEquals( (Integer) 1023, i.get(1) );
        assertEquals( (Integer) 20, i.get(2) );
        ...
        W.preOrder(ast, _anno._hasAnnos.class, n-> n.hasAnno(ann.class), n-> a.add(n));
        ...
        W.postOrder(ast, _anno._hasAnnos.class, n-> n.hasAnno(ann.class), n-> a.add(n));
