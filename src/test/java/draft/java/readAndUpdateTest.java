...
public class readAndUpdateTest extends TestCase {
    ...
    public void testF() {
        ...
        W.in( _c, ExpressionStmt.class, MATCH_SYSTEM_OUT_ST_FN, es -> System.out.println(es));
        //_c.walk(ExpressionStmt.class, MATCH_SYSTEM_OUT_ST_FN, es -> System.out.println(es));
        W.in( _c, ExpressionStmt.class, MATCH_SYSTEM_OUT_ST_FN, es -> es.getParentNode().get().remove(es));
