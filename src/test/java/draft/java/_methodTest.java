...
public class _methodTest extends TestCase {
    ...
    */
    ...
    public void testMethodRemoveStatements(){
        ...
        W.in( _ih.getBody().ast(), ExpressionStmt.class, MATCH_SYSTEM_OUT_ST_FN, e-> sof.add(e) );
        //_ih.walkBody( ExpressionStmt.class, MATCH_SYSTEM_OUT_ST_FN, e-> sof.add(e) );

        assertEquals( 4, sof.size() );

        W.in( _ih.getBody().ast(), ExpressionStmt.class, MATCH_SYSTEM_OUT_ST_FN, e-> e.remove() );
    ...
    */
    ...
    public void testMatch(){
        ...
        //ideally we want
        assertTrue( W.list(_class.of(_methodTest.class),_method.class ).size() >=5);
        ...
        assertTrue( W.list( _class.of(_methodTest.class),_method.class, mm ).size() >=5 );
        
        assertTrue( W.list(_class.of(_methodTest.class),_method.class ).size() >=5 );
        assertTrue( W.list(_class.of(_methodTest.class), _method.class,
