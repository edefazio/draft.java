...
public class _io{
    ...
    /**
     * System property NAME for the paths to IDE projects where files are resolved from
     * <PRE>
    ...
    /**
     * System property NAME for the paths to write output (source files, class files)
